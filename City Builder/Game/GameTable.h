...
public:
	...
	//Setter
	void Set_TableValue(int x, int y, FieldType type) { m_Table[x][y] = GameField::CreateField(type); } // TODO: Delete previous field (We are using heap to store objects -> need to delete)
