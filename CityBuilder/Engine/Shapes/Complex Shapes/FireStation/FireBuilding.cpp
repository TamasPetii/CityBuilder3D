...
void FireBuilding::CreateBuffers(GLuint buffer_size)
{
	...
	cube_layout.TextureDetails.FRONT_ID = 40;
	cube_layout.TextureDetails.BACK_ID = 40;
	cube_layout.TextureDetails.LEFT_ID = 40;
	cube_layout.TextureDetails.RIGHT_ID = 40;
	cube_layout.TextureDetails.TOP_ID = 41;
	cube_layout.TextureDetails.BOTTOM_ID = 41;
